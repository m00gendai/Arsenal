...
import { defaultBottomBarIconSize, defaultViewPadding, screenNameParamsPart } from "configs/configs";
...
export default function BottomBar_PartCollection({handleNavigation, bottomBarRef}:Props){
