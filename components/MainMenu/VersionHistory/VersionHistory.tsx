                    ...
                    {versionHistory.map((version, index) =>{
                        return(
                            ...
                            >
                                ...
                                <Text>{`${version[language].text}`}</Text>
                                {Platform.OS === "ios" && version[language].ios ? <View><Text style={{fontStyle: "italic"}}>{`\niOS:`}</Text><Text>{version[language].ios}</Text></View> : null}
                                {Platform.OS === "android" && version[language].android ? <View><Text style={{fontStyle: "italic"}}>{`\nAndroid:`}</Text><Text>{version[language].android}</Text></View> : null}
