...
interface MainMenu_DatabaseOperation{
    ...
    importLegacyDB: SimpleTranslation
}

export const mainMenu_DatabaseOperations:MainMenu_DatabaseOperation = {
    title:{
        de: "Datenbank",
        en: "Database",
        fr: "Base de données",
    ...
    importArsenalDB:{
        de: "Arsenal Datenbank importieren",
        en: "Import Arsenal database",
        fr: "Importer la base de données Arsenal",
        it: "Importazione del database Arsenal",
        ch: "Import d' Arsenal banca da datas",
    },
    importLegacyDB:{
        de: "Alte Arsenal Datenbank importieren (gunDB_17.../ammoDB_17...)",
        en: "Import old Arsenal database (gunDB_17.../ammoDB_17...)",
        fr: "Importer une ancienne base de données de l'Arsenal (gunDB_17.../ammoDB_17...)",
        it: "Importa la vecchia banca dati dell'Arsenal (gunDB_17.../ammoDB_17...)",
        ch: "Importar ina banca da datas da l'Arsenal vegl (gunDB_17.../ammoDB_17...)",
    },
    importCustomCSV:{
