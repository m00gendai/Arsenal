...
import { PartType_RifleUpper } from "lib/interfaces"
...
type TemplateKeys = keyof Omit<PartType_RifleUpper, "id" | "createdAt" | "lastModifiedAt" | "db_id" | "tags" | "images" | "remarks">;

type TemplateItem = {
    name: TemplateKeys
} & SimpleTranslation;

export const emptyRifleUpperObject:PartType_RifleUpper= {
    id: "",
    manufacturer: null,
    model: "",
...
export const partDataTemplate_RifleUpper:TemplateItem[] = Object.keys(emptyRifleUpperObject)
...
export const rifleUpperRemarks: DataTemplateTranslation = dataTemplate_TranslationRemarks.remarks
