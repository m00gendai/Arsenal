import { ReloadingType_Primer } from "lib/interfaces"
...
type TemplateKeys = keyof Omit<ReloadingType_Primer, "id" | "createdAt" | "lastModifiedAt" | "db_id" | "tags" | "images" | "remarks">;

type TemplateItem = {
    name: TemplateKeys
} & SimpleTranslation;

export const emptyPrimerObject:ReloadingType_Primer = {
    id: "",
    createdAt: 0,
    lastModifiedAt: 0,
    images: [],
...
export const reloadingDataTemplate_Primer:TemplateItem[] = Object.keys(emptyPrimerObject)
...
export const primerRemarks: DataTemplateTranslation = dataTemplate_TranslationRemarks.remarks
