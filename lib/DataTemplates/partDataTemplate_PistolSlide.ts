...
import { PartType_ConversionKit, PartType_PistolSlide } from "lib/interfaces"
...
type TemplateKeys = keyof Omit<PartType_PistolSlide, "id" | "createdAt" | "lastModifiedAt" | "db_id" | "tags" | "images" | "remarks">;

type TemplateItem = {
    name: TemplateKeys
} & SimpleTranslation;

export const emptyPistolSlideObject:PartType_PistolSlide= {
    id: "",
    manufacturer: null,
    model: "",
...
export const partDataTemplate_PistolSlide:TemplateItem[] = Object.keys(emptyPistolSlideObject)
...
export const pistolSlideRemarks: DataTemplateTranslation = dataTemplate_TranslationRemarks.remarks
