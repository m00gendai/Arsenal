...
import { PartType_PistolFrame } from "lib/interfaces"
...
type TemplateKeys = keyof Omit<PartType_PistolFrame, "id" | "createdAt" | "lastModifiedAt" | "db_id" | "tags" | "images" | "remarks">;

type TemplateItem = {
    name: TemplateKeys
} & SimpleTranslation;

export const emptyPistolFrameObject:PartType_PistolFrame= {
    id: "",
    manufacturer: null,
    model: "",
...
export const partDataTemplate_PistolFrame:TemplateItem[] = Object.keys(emptyPistolFrameObject)
...
export const pistolFrameRemarks: DataTemplateTranslation = dataTemplate_TranslationRemarks.remarks
