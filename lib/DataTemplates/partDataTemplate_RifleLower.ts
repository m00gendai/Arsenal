...
import { PartType_RifleLower } from "lib/interfaces"
...
type TemplateKeys = keyof Omit<PartType_RifleLower, "id" | "createdAt" | "lastModifiedAt" | "db_id" | "tags" | "images" | "remarks">;

type TemplateItem = {
    name: TemplateKeys
} & SimpleTranslation;

export const emptyRifleLowerObject:PartType_RifleLower= {
    id: "",
    manufacturer: null,
    model: "",
...
export const partDataTemplate_RifleLower:TemplateItem[] = Object.keys(emptyRifleLowerObject)
...
export const rifleLowerRemarks: DataTemplateTranslation = dataTemplate_TranslationRemarks.remarks
