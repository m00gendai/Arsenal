        ...
        if(title?.name){
            switch(title.name){
                ...
                case "bulletCollection":
                    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>gate-and</title><path d="M2,4V20H14A8,8 0 0,0 22,12A8,8 0 0,0 14,4H2M4,6H14A6,6 0 0,1 20,12A6,6 0 0,1 14,18H4V6Z" /></svg>
                case "caseCollection":
                    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>test-tube-empty</title><path d="M7,2H17V4H16V18A4,4 0 0,1 12,22A4,4 0 0,1 8,18V4H7V2M14,4H10V18A2,2 0 0,0 12,20A2,2 0 0,0 14,18V4Z" /></svg>
